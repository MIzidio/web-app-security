...
Cada categoria de vulnerabilidade descrita nas seções anteriores possui mecanismos de defesa específicos, com diferentes níveis de efetividade e limitações. A Tabela \ref{tab:tecnicas_defesa} consolida a relação entre técnicas de defesa, ataques mitigados e suas restrições, com base em trabalhos de classificação como os de Halfond et al. (2006), Gupta e Gupta (2015), Barth et al. (2008) e OWASP Top 10:2021.
...
Sureda Riera et al. (2022) realizaram uma análise sistemática da efetividade de ferramentas de proteção em runtime, comparando WAF e RASP em diferentes categorias de ataque. Os resultados indicam que o RASP supera o WAF em precisão por categoria de ataque, em parte devido ao conhecimento contextual da aplicação. A Tabela  \ref{tab:comparativo_waf_rasp} sintetiza o comparativo empírico com base nesse estudo.
